...
namespace CodedUITestProject1
{
    ...
    public class UIEasterEggsMenuItem : WinMenuItem
    {
        ...
        #region Properties
        public WinMenuItem UIBackgroundMenuItem
        {
            get
            {
                if ((this.mUIBackgroundMenuItem == null))
                {
                    this.mUIBackgroundMenuItem = new WinMenuItem(this);
                    #region Search Criteria
                    this.mUIBackgroundMenuItem.SearchProperties[WinMenuItem.PropertyNames.Name] = "Background";
                    this.mUIBackgroundMenuItem.SearchConfigurations.Add(SearchConfiguration.ExpandWhileSearching);
                    this.mUIBackgroundMenuItem.WindowTitles.Add("Spreadsheet");
                    #endregion
                }
        ...
        #region Fields
        private WinMenuItem mUIBackgroundMenuItem;
        #endregion
    }
